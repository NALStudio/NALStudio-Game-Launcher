...
{
	/// <summary>This component will update a <b>UI.TMP_Dropdown</b> component with localized text, or use a fallback if none is found.</summary>
	[ExecuteInEditMode]
	[DisallowMultipleComponent]
	[RequireComponent(typeof(TMP_Dropdown))]
	[HelpURL(LeanLocalization.HelpUrlPrefix + "LeanLocalizedDropdown")]
	[AddComponentMenu(LeanLocalization.ComponentPathPrefix + "Localized TMP_Dropdown")]
